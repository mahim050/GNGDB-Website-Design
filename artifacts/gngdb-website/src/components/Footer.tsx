        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div className="lg:col-span-2">
            ...
            <p className="text-zinc-400 text-lg leading-relaxed max-w-md mb-8">
              Gono Netritto Gothon Unnayan Bangladesh. Dedicated to youth empowerment and sustainable community development since our inception.
            </p>
          ...
          <div>
            ...
            <p className="text-zinc-400 mb-6">Your contribution helps us create more leaders and better communities.</p>
